...
//
int add_timer_func_list(int (*func)(int,unsigned int,intptr_t,intptr_t), char* name) {
...
char* search_timer_func_list(int (*func)(int,unsigned int,intptr_t,intptr_t)) {
	struct timer_func_list* tfl;
